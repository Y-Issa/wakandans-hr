...
const AssignUserTeam: React.FC<AssignUserTeamProps> = ({
  ...
  const filteredUsers = allUsers.filter(
    (user) =>
      !usersInTeam.some((teamUser) => teamUser.userId === user.id) &&
  ...
  return (
    ...
    >
      <div className='bg-white p-6 rounded-lg shadow-lg w-[40rem]'>
        <h2 className='text-lg font-bold mb-4'>Assign Employee to Team</h2>
        ...
        <div className='fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center'>
          <div className='bg-white p-6 rounded-lg shadow-lg w-96'>
            ...
            <p className='text-sm mb-4'>
              Are you sure you want to assign this user to the team?
            </p>
