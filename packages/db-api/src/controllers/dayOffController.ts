...
export const createDayOff = async (req: Request, res: Response) => {
  ...
  try {
    ...
    handle500Response(
      res,
      error,
      'Error occurred while creating day-off',
...
export const updateDayOff = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(200).json({
      message: 'DayOff successfully updated',
      data: dayOff,
    });
  } catch (error) {
    handle500Response(
      res,
      error,
      'Error occurred while updating day-off',
...
export const deleteDayOff = async (req: Request, res: Response) => {
  ...
  try {
    ...
    res.status(200).json({
      message: 'DayOff successfully deleted',
      data: dayOff,
    });
  } catch (error) {
    handle500Response(
      res,
      error,
      'Error occurred while deleting day-off',
